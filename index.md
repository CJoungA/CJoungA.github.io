...
## [개발작업(3주)]
  ...
  작업명 :  재장전 마무리 및 총기 1, 크로스헤어 제작

  해당 요구사항 : 

  1) 재장전 관련 사항을 만든다. (21)
  2) 고유의 반동과 능력치를 가진 총기 1을 제작한다. (9)
  3) 화면 중앙에 고정된 크로스헤어를 제작한다. (10)
...
## [개발작업(4주)]
  ...
  1) 고유의 반동과 능력치를 가진 총기 1을 제작한다. (5)
  2) 적은 3개의 지점에서 생성된다.(6)
  3) 일반, 이동속도강화, 체력강화 타입의 적이 있다.(7)
...
## [개발작업(5주)]
  ...
  1) 일반, 이동속도강화, 체력강화 타입의 적이 있다.(8)
  2) 적을 죽이면 점수가 올라간다.(9)
  3) 탄약의 총합이 0이거나 남은시간이 0이 되면 게임을 종료한다.(11)
