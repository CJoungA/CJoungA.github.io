...
## [ 요구사항 1년 ]<a name='8_1'></a>
   ...
   16. 화면 중앙에 고정된 크로스헤어(조준점)을 제작한다.
   17. 게임이 종료되면 통계화면으로 전환된다.
   18. 통계화면에는 점수 및 명중률, 치명타 명중률, 부위별 명중률이 표기되며 시작화면버튼이 있다.
   19. 점수는 일반적은 100점 강화된적은 200점을 주며 치명타(머리)를 맞췄을 경우 2배 증가한다.
   20. 다양한 효과음과 BGM이 들어간다.
   21. 마우스 감도를 조절할수 있다.
   22. 재장전관련 사항을 만든다.
   <br>
